...
import { ArrowLeft, Loader2, AlertTriangle, ReceiptText } from 'lucide-react'; // Using ReceiptText for refund
import { getSitePageContent } from '@/lib/firebase/firestoreSitePages';
import type { SitePage } from '@/lib/types';

const PAGE_ID = "refund-policy";
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-3xl md:text-4xl flex items-center">
             ...
             pageContent?.title ? <><ReceiptText className="mr-3 h-8 w-8 text-primary" /> {pageContent.title}</> : "Refund Policy"
            }
          </CardTitle>
        </CardHeader>
        <CardContent>
