...
export default async function DeveloperGuidePage() {
  const markdownContent = await getStaticMarkdownContent('developer-guide-content.md');
  const pageTitle = "RIO Developer Guide";
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-3xl md:text-4xl flex items-center">
            <Wrench className="mr-3 h-8 w-8 text-primary" /> {pageTitle}
          </CardTitle>
        </CardHeader>
        <CardContent>
